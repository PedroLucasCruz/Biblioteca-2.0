...
namespace Biblioteca._2._0.Domain.Services
{
    ...
    /// </summary>
    public class ServicoFichaEmprestimoAlunoImpl :  IServicoFichaEmprestimoAluno
    {


        private readonly ILogger _logger;
        //private readonly INotificacaoEmail _NotificacaoEmail;
        private readonly IServicoUsuarioImplRepositorio servicoUsuarioImplRepositorio;

        public ServicoFichaEmprestimoAlunoImpl(ILogger logger, IServicoUsuarioImplRepositorio servicoUsuarioImplRepositorio)
        {
            _logger = logger;
            this.servicoUsuarioImplRepositorio = servicoUsuarioImplRepositorio;
        }
